 ...
 */
var option = Computer(ram: 0, yearManufactured: 10)
var option1 = Computer(ram: 7, yearManufactured: 1983)
print(option?.ram, option?.yearManufactured)
print(option1?.ram, option1?.yearManufactured)
